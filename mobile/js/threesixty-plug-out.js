(function ($) {
	...
	*/
	function loadImage() {
		for (var i = 0; i < totalFrames; i++) {
			...
			var imageName = settings.pathImages + (loadedImages + 1) + ".png";
	...
	*/
	function imageLoaded() {
		...
		settings.spinnerSpan.text(Math.floor(loadedImages / totalFrames * 100) + "%");
		...
		if (loadedImages == totalFrames) {
			...
			*/
			// settings.spinner.fadeOut("slow", function(){
			// 	spinner.hide();
			// 	showThreesixty();
			// });
	...
	*/
	function render () {
		...
		showHideHotSpots(Math.abs(currentFrame%60));
	};

	function showHideHotSpots(currentFrame) {
		...
		if (currentFrame >= 0 && currentFrame < 8) {
			...
			settings.spot7.hide();
			settings.spot8.hide();
			settings.spot2.dragging();
		} else if (currentFrame >= 16 && currentFrame < 23) {
			settings.spot1.hide();
			settings.spot2.hide();
			settings.spot3.show();
			settings.spot4.hide();
			...
			settings.spot7.hide();
			settings.spot8.hide();
			settings.spot3.dragging();
		} else if (currentFrame >= 23 && currentFrame < 30) {
			settings.spot1.hide();
			settings.spot2.hide();
			settings.spot3.hide();
			settings.spot4.show();
			...
			settings.spot7.hide();
			settings.spot8.hide();
			settings.spot4.dragging();
		} else if (currentFrame >= 30 && currentFrame < 37) {
			settings.spot1.hide();
			settings.spot2.hide();
			settings.spot3.hide();
			settings.spot4.hide();
			...
			settings.spot7.hide();
			settings.spot8.hide();
			settings.spot5.dragging();
		} else if (currentFrame >= 37 && currentFrame < 44) {
			settings.spot1.hide();
			settings.spot2.hide();
			settings.spot3.hide();
			settings.spot4.hide();
			...
			settings.spot7.hide();
			settings.spot8.hide();
			settings.spot6.dragging();
		} else if (currentFrame >= 44 && currentFrame < 51) {
			settings.spot1.hide();
			settings.spot2.hide();
			settings.spot3.hide();
			settings.spot4.hide();
			...
			settings.spot7.show();
			settings.spot8.hide();
			settings.spot7.dragging();
		} else if (currentFrame >= 51 && currentFrame < 60) {
			settings.spot1.hide();
			settings.spot2.hide();
			settings.spot3.hide();
			settings.spot4.hide();
